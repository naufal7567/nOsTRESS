...
class ViewPagerAdapter_Solusi_Stres(private val title: List<String>, private val image: List<Int>)
    : RecyclerView.Adapter<ViewPagerAdapter_Solusi_Stres.Pager2ViewHolder>() {
