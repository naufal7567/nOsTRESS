...
class ViewPagerAdapter_Tingkatan_Stres(private val title: List<String>, private val desc: List<String>, private val image: List<Int>)
    : RecyclerView.Adapter<ViewPagerAdapter_Tingkatan_Stres.Pager2ViewHolder>() {
