...
class ViewPagerAdapter_Pengertian_Stres(private val title: List<String>, private val desc: List<String>, private val image: List<Int>)
    : RecyclerView.Adapter<ViewPagerAdapter_Pengertian_Stres.Pager2ViewHolder>() {
