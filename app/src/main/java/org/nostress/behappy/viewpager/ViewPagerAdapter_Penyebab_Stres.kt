...
class ViewPagerAdapter_Penyebab_Stres(private val title: List<String>, private val desc: List<String>, private val image: List<Int>)
    : RecyclerView.Adapter<ViewPagerAdapter_Penyebab_Stres.Pager2ViewHolder>() {
